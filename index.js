...
function changeBackgroundColor() {
    ...
    if (scrollPosition > 10) {
        // header.style.backgroundColor = '#754E1A'
        // navlink.style.backgroundColor = '#754E1A';
        let name = document.getElementById('name').style.color = "#F8E1B7"
...
educatebtn.addEventListener('click', () => {
    ...
    educatebtn.style.backgroundColor = "#CBA35C"; // Set active button color
...
experiencebtn.addEventListener('click', () => {
    resetButtonColors(); // Reset all button colors
    experiencebtn.style.backgroundColor = "#CBA35C"; // Set active button color
...
skillbtn.addEventListener('click', () => {
    resetButtonColors(); // Reset all button colors
    skillbtn.style.backgroundColor = "#CBA35C"; // Set active button color
...
const sentences = ["Accountant", "Accounting"];
let part = 0;
let index = 0;
let interval = 100;
